...
document.getElementById("placeOrder").addEventListener
    ("click", placeOrder);//event listener calls function
/**
* gets form values
* calculates prices
* produces output
...
function placeOrder() {
    ...
    var birthday =
        document.getElementById("birthday").value;//the past 4 are inputs
    // get the pizza price
    ...
    // output the delivery price, if there is one - defensive programming
    if (deliveryPrice === 0) {
